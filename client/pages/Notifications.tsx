...
import { ArrowLeft, Check, X, Settings, Bell, Camera, TrendingUp, Heart, Zap } from 'lucide-react';
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      type: 'achievement',
      title: '🎉 Goal Achieved!',
      message: 'Congratulations! You\'ve hit your protein target for 7 days straight. Keep up the excellent work!',
    ...
    },
    {
      ...
      message: 'Don\'t forget to scan your lunch! You have 3 AI scans remaining today.',
    ...
    },
    {
      ...
      message: 'Adding a handful of berries to your breakfast can boost antioxidants and help with brain function!',
    ...
    },
    {
      ...
      message: 'Your weekly health insights report is ready! See how you performed this week.',
    ...
    },
    {
      ...
      message: 'Amazing! You\'ve logged meals for 14 consecutive days. You\'re building great habits!',
    ...
    },
    {
      ...
      type: 'reminder',
      title: 'Mood Check-in',
      message: 'How are you feeling today? Get personalized food recommendations based on your current mood.',
    ...
    },
    {
      ...
      message: 'You\'re halfway through your day! Remember to drink water regularly for optimal energy levels.',
    ...
    },
    {
      ...
      message: 'We\'ve improved our AI scanning accuracy! Try scanning your next meal to experience 95%+ accuracy.',
            ...
            {filteredNotifications.map((notification) => (
              ...
              >
                <div className="flex gap-4">
                  {/* Icon */}
                  <div className={`w-12 h-12 ${notification.iconColor} rounded-full flex items-center justify-center text-2xl flex-shrink-0`}>
                    {notification.icon}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <h4 className={`font-medium ${!notification.read ? 'text-primary' : 'text-gray-900'}`}>
                        {notification.title}
                      </h4>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Our AI learns your patterns and sends personalized reminders at the optimal times to help you stay on track with your health goals.
              </p>
            </div>
          </div>
        </div>
