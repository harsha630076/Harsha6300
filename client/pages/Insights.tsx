...
export default function Insights() {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "15 scans this week",
      icon: "📸",
      ...
      <div className="px-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {achievements.map((achievement) => (
            ...
            >
              <div
                className={`w-10 h-10 ${achievement.color} rounded-full flex items-center justify-center text-lg mb-3`}
              >
                {achievement.icon}
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Your protein intake has improved by 9% this week! This supports
                muscle recovery and helps maintain satiety throughout the day.
              </p>
            </div>
          </div>
        </div>
