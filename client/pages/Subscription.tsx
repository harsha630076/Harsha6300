  ...
  const premiumBenefits = [
    {
      ...
      description:
        "More precise calorie tracking and dietary analysis powered by advanced algorithms.",
      included: true,
    },
    {
      icon: "⚖️",
      ...
      description:
        "Personalized meal plans generated to perfectly match your health goals and preferences.",
      included: true,
    },
    {
      icon: "☕",
      ...
      description:
        "Instant, intelligent assistance for all your health and app-related queries.",
      included: true,
    },
    {
      icon: "🧡",
      ...
      description:
        "Receive food recommendations tailored to your current mood, energy, or recovery needs.",
      included: true,
    },
    {
      icon: "$",
      ...
      description:
        "Enjoy uninterrupted tracking and recommendations without any advertisements.",
      included: true,
    },
    {
      icon: "📊",
      ...
      description:
        "Detailed charts, trends, and health predictions based on your data.",
      included: true,
    },
    {
      icon: "🔄",
    ...
    },
    {
      ...
      description:
        "Export your health data and keep secure backups of your progress.",
      included: true,
    },
  ];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 py-12 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-md mx-auto">
            Get personalized insights, unlimited AI scans, and advanced features
            to reach your health goals faster.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          {freeFeatures.map((feature, index) => (
            <div
              key={index}
              className="grid grid-cols-3 gap-4 py-3 border-t border-gray-100"
            >
              ...
              <div className="text-center">
                ...
                <div className="mb-4">
                  ...
                  <span className="text-gray-600 ml-1">
                    {showYearly
                      ? pricingPlans.yearly.period
                      : pricingPlans.monthly.period}
                  </span>
                  {showYearly && (
                ...
                <p className="text-gray-600 mb-6">
                  All premium features including unlimited AI scans and
                  personalized plans
                </p>
                <Button
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-sm text-gray-600">
              ...
              profile settings. No questions asked.
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h4 className="font-semibold text-gray-900 mb-2">
            ...
            <p className="text-sm text-gray-600">
              Your free trial includes all premium features. If you don't
              cancel, you'll be charged for your selected plan.
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h4 className="font-semibold text-gray-900 mb-2">
            ...
            <p className="text-sm text-gray-600">
              Our AI achieves 95%+ accuracy for most common foods and
      ...
      <div className="px-6 pb-8">
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-6 text-center text-white">
          ...
          <p className="text-purple-100 mb-6">
            Join thousands of users who've achieved their goals with QuickCal AI
            Premium
          </p>
          <Button
            onClick={handleTrialStart}
        ...
        <div className="bg-green-50 rounded-2xl p-4 border border-green-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Premium users lose weight 3x faster on average thanks to
                personalized meal plans and mood-based recommendations!
              </p>
            </div>
          </div>
        </div>
