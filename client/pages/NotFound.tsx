...
export default function NotFound() {
  ...
  const popularPages = [
    { name: "Food Log", path: "/log", description: "View your meal history" },
    {
      ...
      description: "Mood-based food suggestions",
    },
    {
          ...
          <div className="grid grid-cols-2 gap-3">
            {quickActions.map((action) => (
              <Link key={action.path} to={action.path}>
                ...
                >
                  <div
                    className={`w-8 h-8 ${action.color} rounded-full flex items-center justify-center`}
                  >
      ...
      <div className="px-6 pb-8">
        <div className="bg-gray-50 rounded-2xl p-4 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Contact our support team or check our help center for more
            assistance.
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                While you're here, remember that tracking your meals
                consistently can improve your health goals achievement by up to
                70%!
              </p>
            </div>
          </div>
