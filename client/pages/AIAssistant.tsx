  ...
  const initialMessages: Message[] = [
    {
      ...
      type: "assistant",
      content:
        "Hi Alex! 👋 I'm your AI nutrition assistant. I can help you with meal planning, nutrition advice, food recommendations, and tracking your health goals. What would you like to know today?",
      timestamp: new Date(),
      quickActions: [
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                I learn from your preferences and goals to provide increasingly
                personalized nutrition advice. The more we chat, the better I
                can help you!
              </p>
            </div>
          </div>
