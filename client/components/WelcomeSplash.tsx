...
export default function WelcomeSplash({ isVisible, onComplete }: WelcomeSplashProps) {
      ...
      <div className={`text-center transition-all duration-500 transform ${
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute inset-0 -m-8">
            <div className="w-40 h-40 border border-white/20 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
          </div>
        </div>
        ...
        <p className="text-lg text-white/90 animate-in slide-in-from-bottom-4" style={{ animationDelay: '0.2s' }}>
