...
export default function DownloadButton({
  ...
  const downloadAPK = () => {
    ...
    alert(
      '📱 APK download started! Enable "Install from unknown sources" in Android settings to install.',
    );
  };
    ...
    <div className="space-y-2">
      ...
      {variant === "data" && (
        <div className="text-xs text-gray-500 space-y-1">
          <p>
            📊 Includes: Personal info, food logs, notifications, and progress
            data
          </p>
          <p>
            🔒 Your data is exported securely and never shared with third
            parties
          </p>
